  ...
  config = lib.mkIf config.modules.zsh.enable {
    ...
    programs.starship = with config.lib.stylix.colors; {
      ...
      settings = {
        ...
        directory = {
          format = "[]($style)[  ](bg:#${base01} fg:#${base05})[$path](bg:#${base01} fg:#${base09} bold)[ ]($style)";
          style = "bg:none fg:#${base01}";
          truncation_length = 3;
          truncate_to_repo = false;
        };
        git_branch = {
          format = "[]($style)[[ ](bg:#${base01} fg:#${base05} bold)$branch](bg:#${base01} fg:#${base09} bold)[ ]($style)";
          style = "bg:none fg:#${base01}";
        };
        git_status = {
        ...
        cmd_duration = {
          min_time = 1;
          # duration & style ;
          format = "[]($style)[[  ](bg:#${base01} fg:#${base05} bold)$duration](bg:#${base01} fg:#${base09} bold)[]($style)";
          disabled = false;
          style = "bg:none fg:#${base01}";
        };
        nix_shell = {
        ...
        kubernetes = {
          ...
          disabled = false;
          style = "fg:#${base09} bg:#${base01} bold";
          context_aliases = {
